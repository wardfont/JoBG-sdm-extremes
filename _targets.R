...
options(
  ...
  clustermq.ssh.host = "vsc33336@login.hpc.kuleuven.be", # use your user and host, obviously
  clustermq.template = "/home/wardfont/projects/historytrees/ssh-working.tmpl", # if changing the default connection timeout
...
tar_plan(
  ...
  limited_one_spatial_plot_gam_biovars = spatial_plot_limited_ensemble(
    katz_ensemble_gam_biovars_predictions,
    base_ensemble_gam_biovars_predictions,
    euforest,
    species,
  ...
  ## ## ## Ensemble predictions for biovar models
  ## tar_target(
  ##   edge_katz_ensemble_gam_biovars_predictions,
  ##   gam_ensemble(euforest_gam_biovars,
  ##     model = "katz",
  ##     edge_display_species,
  ##     env_files = c(terraclimate_sdm[[1]]$file, terraclimate_biovars[[1]]$file)
  ##   ),
  ##   pattern = map(edge_display_species),
  ##   garbage_collection = T
  ## ),
  ## tar_target(
  ##   edge_base_ensemble_gam_biovars_predictions,
  ##   gam_ensemble(euforest_gam_biovars,
  ##     model = "base",
  ##     edge_display_species,
  ##     env_files = c(terraclimate_sdm[[1]]$file, terraclimate_biovars[[1]]$file)
  ...
  ##   garbage_collection = T
  ## ),
  ## edge_limited_one_spatial_plot_gam_biovars = spatial_plot_limited_ensemble(
  ##   edge_katz_ensemble_gam_biovars_predictions,
  ##   edge_base_ensemble_gam_biovars_predictions,
  ##   euforest,
  ##   species,
